...
drop _m boardid boardname directorname date_DR
...
keep gvkey duns year directorid death_dum death_shock
...
keep gvkey year directorid Treat timing numEvent
...
duplicates drop gvkey year directorid, force
...
keep gvkey year directorid $connection_DR

merge 1:m gvkey year directorid using "Stacked Data"
